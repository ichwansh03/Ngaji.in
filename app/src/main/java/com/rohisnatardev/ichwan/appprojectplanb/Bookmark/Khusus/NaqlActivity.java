...
ImageButton btnnaql;
    ...
    public void play_naql(View view){
        if (playerNaql == null){
            playerNaql = MediaPlayer.create(this,R.raw.naql);
        }
        playerNaql.start();
    }
    public void pause_naql(View view){
        playerNaql.pause();
    }
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.textNextBtn:
                Intent naql = new Intent(NaqlActivity.this,SaktahActivity.class);
                startActivity(naql);
                break;
            case R.id.play_toggle_naql:
                setmpnaql();
                break;
        }
    }
