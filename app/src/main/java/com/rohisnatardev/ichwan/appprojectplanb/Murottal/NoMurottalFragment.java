...
public class NoMurottalFragment extends DialogFragment {

    public NoMurottalFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_no_murottal, container, false);
