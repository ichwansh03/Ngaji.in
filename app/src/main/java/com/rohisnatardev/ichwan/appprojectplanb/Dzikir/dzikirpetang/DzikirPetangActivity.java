...
public class DzikirPetangActivity extends AppCompatActivity {
    ...
    private void datadPetang(){
        list = new ArrayList<>();

        list.add(new DzikirPetangItem("Ta\'awudz","Dibaca 1x",
        ...
        list.add(new DzikirPetangItem("Al-Fatihah","Dibaca 1x",
        ...
        list.add(new DzikirPetangItem("Al-Baqarah 1-5","Dibaca 1x",
                "بِسْمِ اللّٰهِ الرَّحْمٰنِ الرَّحِيْمِ\n" +
                        "الۤمّۤ ۚ\n" +
        ...
        list.add(new DzikirPetangItem("Al-Baqarah 255-257","Dibaca 1x",
                ...
                "Allah, tidak ada tuhan selain Dia. Yang Mahahidup, Yang terus menerus mengurus (makhluk-Nya), tidak mengantuk dan tidak tidur. Milik-Nya apa yang ada di langit dan apa yang ada di bumi. Tidak ada yang dapat memberi syafaat di sisi-Nya tanpa izin-Nya. Dia mengetahui apa yang di hadapan mereka dan apa yang di belakang mereka, dan mereka tidak mengetahui sesuatu apa pun tentang ilmu-Nya melainkan apa yang Dia kehendaki. Kursi-Nya meliputi langit dan bumi. Dan Dia tidak merasa berat memelihara keduanya, dan Dia Mahatinggi, Mahabesar.* Tidak ada paksaan dalam (menganut) agama (Islam), sesungguhnya telah jelas (perbedaan) antara jalan yang benar dengan jalan yang sesat. Barang siapa ingkar kepada Tagut dan beriman kepada Allah, maka sungguh, dia telah berpegang (teguh) pada tali yang sangat kuat yang tidak akan putus. Allah Maha Mendengar, Maha Mengetahui. * Allah pelindung orang yang beriman. Dia mengeluarkan mereka dari kegelapan kepada cahaya (iman). Dan orang-orang yang kafir, " +
                        "pelindung-pelindungnya adalah setan, yang mengeluarkan mereka dari cahaya kepada kegelapan. Mereka adalah penghuni neraka. Mereka kekal di dalamnya."));

        list.add(new DzikirPetangItem("Al-Baqarah 284-286","Dibaca 1x",
        ...
        list.add(new DzikirPetangItem("Al-Ikhlas","Dibaca 3x",
                "بِسْمِ اللّٰهِ الرَّحْمٰنِ الرَّحِيْمِ\n" +
        ...
        list.add(new DzikirPetangItem("Al-Falaq","Dibaca 3x",
                "بِسْمِ اللّٰهِ الرَّحْمٰنِ الرَّحِيْمِ\n" +
        ...
        list.add(new DzikirPetangItem("An-Nas","Dibaca 3x",
                "بِسْمِ اللّٰهِ الرَّحْمٰنِ الرَّحِيْمِ\n" +
        ...
        list.add(new DzikirPetangItem("Doa Sore Hari","Dibaca 3x",
                "اَمْسَيْنَا وَاَمْسَى الْمُلْكُ لِلَّهِ وَالْحَمْدُ لِلَّهِ لاَشَرِيْكَ لَهُ لاَإِلَهَ إِلاَّ هُوَ وَإِلَيْهِ الْمَصِيْرُ",
                "Amsaina wa amsa mulku lillahi walhamdulillahi la syarikallahu la illaha illa huwa wa-ilaihil masiir",
                "Kami bersore hari dan berpagi hari pula kerajaan milik Allah. Segala puji bagi Allah, tiada sekutu bagi-Nya, tiada Tuhan melainkan Dia dan kepada-Nya tempat kembali"));

        list.add(new DzikirPetangItem("Doa Sore Hari","Dibaca 3x",
                "أَمْسَيْنَا عَلَى فِطْرَةِ الإِسْلاَمِ وَكَلِمَةِ الإِخْلاَصِ وَعَلَى دِيْنِ نَبِيِّنَا مُحَمَّدٍ صَلَّى اللَّهُ عَلَيْهِ وَسَلَّمَ وَعَلَى مِلَّةِ أَبِيْنَا إِبْرَهِيْمَ حَنِيْفًا وَمَا كَانَ مِنَ الْمُشْرِكِيْنَ",
                ...
                "Kami bersore hari di atas fitrah Islam, di atas kalimat ikhlash, di atas agama nabi Muhammad SAW, dan di atas milah (agama) bapak kami; Ibrahim yang hanif. Dan ia bukan termasuk golongan orang-orang yang musyrik"));

        list.add(new DzikirPetangItem("Doa Sore Hari","Dibaca 3x",
                "اَللَّهُمَّ اِنِّى أَمْسَيْتُ مِنْكَ فِيْ نِعْمَةٍ وَعَافِيَةٍ وَسِتْرٍ فَاَتِمَّ عَلَيَّ نِعْمَتَكَ" +
                        "وَعَافِيَتَكَ وَسِتْرَكَ فِي الدُّنْيَا وَالآخِرَة",
                "Allohumma inni amsaitu minka fi ni’matin wa’afiyatin wa sittrin-fa atimma ’alayya ni’mataka wa’afiyataka wa sit-roka fiddun-ya wal aakhirot",
                "Ya Allah, sesungguhnya kami bersore hari dari-Mu dalam kenikmatan, kesehatan dan perlindungan. Maka sempurnakanlah bagi kami kenikmatan, kesehatan dan perlindungan-Mu di dunia dan akhirat"));

        list.add(new DzikirPetangItem("Doa Sore Hari","Dibaca 3x",
                "اَللَّهُمَّ مَاأَمْسَى بِيْ مِنْ نِعْمَةٍ أَوْ بِأَحَدٍ مِنْ خَلْقِكَ فَمِنْكَ وَحْدَكَ لاَشَرِيْكَ لَكَ فَلَكَ الْحَمْدُ وَلَكَ الِشُّكْرُ",
                "Allohumma maa amsa biimini’matin au bi ahadin min kholqika fa minka wahdaka la syariika laka falakalhamdu walakassyukru",
                "Ya Allah, segala kenikmatan yang bersore hari (terjadi) bersamaku atau bersama salah satu dari makhluk-Mu, adalah dari-Mu semata; tiada sekutu bagi-Mu. Maka bagi-Mu segala puji dan bagi-Mu rasa syukur"));

        list.add(new DzikirPetangItem("*HR. Imam Ahmad dan Ibnu Majah","Dibaca 3x",
        ...
        list.add(new DzikirPetangItem("*HR. Abu Dawud","Dibaca 3x",
        ...
        list.add(new DzikirPetangItem("*HR. Muslim","Dibaca 3x",
        ...
        list.add(new DzikirPetangItem("*HR. Abu Dawud dan Tirmidzi","Dibaca 3x",
        ...
        list.add(new DzikirPetangItem("*HR. Imam Ahmad dan Thabrani","Dibaca 3x",
        ...
        list.add(new DzikirPetangItem("*HR. Ibnu Hibban","Dibaca 3x",
        ...
        list.add(new DzikirPetangItem("*HR. Ahmad","Dibaca 3x",
        ...
        list.add(new DzikirPetangItem("*HR. Bukhari","Dibaca 3x",
        ...
        list.add(new DzikirPetangItem("*HR. Abu Dawud, Tirmidzi dan Hakim","Dibaca 3x",
        ...
        list.add(new DzikirPetangItem("*HR. Thabrani (Shalawat Nabi)","Dibaca 10x",
        ...
        list.add(new DzikirPetangItem("*HR. Tirmidzi","Dibaca 100x",
                "سُبْحَانَ اللَّهِ وَالْحَمْدُ لِلَّهِ وَلاَ إِلَهَ إِلاَّ اللَّهُ وَاللَّهُ أَكْبَرُ",
                "Subhanalloohi wal hamdu lillaahi wala illaaha illalloohu walloohu akbar",
                "Maha Suci Allah, segala puji bagi Allah, tiada Tuhan melainkan Allah dan Allah Maha Besar"));

        list.add(new DzikirPetangItem("*HR. Imam Ahmad dan Thabrani","Dibaca 10x",
        ...
        list.add(new DzikirPetangItem("*HR. Nasa'i dan Hakim","Dibaca 3x",
        ...
        list.add(new DzikirPetangItem("*Perkataan Imam Nawawi dalam kitab Al-Adzkar","Dibaca 1x",
        ...
        list.add(new DzikirPetangItem("Ali Imran 26-27","Dibaca 1x",
        ...
        list.add(new DzikirPetangItem("Doa Sore Hari","Dibaca 1x","" +
                "اَللَّهُمَّ إِنَّ هَذَا إِقْبَالُ لَيْلِكَ وَإِدْبَارُ نَهَارِكَ، وَأَصْوَاتُ دُعَاتِكَ فَاغْفِرْلِي",
                "Alloohumma inna haadzaa iqbalu lailika wa idzbaaru naharika wa ashwatu dua’atika faghfirlii",
        ...
        list.add(new DzikirPetangItem("Doa Al-Matsurah","Dibaca 1x",
    ...
    private void datarvPetang(){
        DzikirPetangAdapter petangAdapter = new DzikirPetangAdapter(list);
        rvdpetang.setLayoutManager(new LinearLayoutManager(this));
        rvdpetang.setAdapter(petangAdapter);
    }
}
